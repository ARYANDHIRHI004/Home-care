...
export default function CouponFilters({ searchQuery, onSearchChange }) {
    const [isFiltersOpen, setIsFiltersOpen] = useState(false);

    const filterOptions = [
        { label: 'Status', options: ['All Statuses', 'Active', 'Scheduled', 'Paused', 'Expired', 'Draft'] },
        { label: 'Type', options: ['All Types', 'Percentage', 'Flat Amount', 'Free Service', 'Free Visit'] },
        { label: 'Category', options: ['All Categories', 'Deep Cleaning', 'Plumbing', 'Electrical'] },
        { label: 'Date Range', options: ['Any Time', 'Currently Valid', 'Starting Soon', 'Expired Last 30 Days'] },
        { label: 'Created By', options: ['Anyone', 'Admin', 'Marketing Team'] },
    ];
