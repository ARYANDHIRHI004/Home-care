...
export default function ExpenseFilters({ searchQuery, onSearchChange }) {
    const [isFiltersOpen, setIsFiltersOpen] = useState(false);

    const filterOptions = [
        { label: 'Category', options: ['All Categories', 'Fuel', 'Partner Advance', 'Office Rent', 'Electricity', 'Internet', 'Marketing', 'Salary', 'Transport', 'Maintenance', 'Miscellaneous'] },
        { label: 'Payment Method', options: ['All Methods', 'Corporate Card', 'UPI', 'Bank Transfer', 'Petty Cash'] },
        { label: 'Date Range', options: ['Any Time', 'Today', 'This Week', 'This Month', 'Last Month'] },
    ];
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-6 sticky top-20 z-10 min-w-0">
            ...
            <div className="flex gap-3 min-w-0">
                <div className="relative flex-1 min-w-0">
                    ...
                    <input
                        ...
                        placeholder="Search description, vendor, or expense ID..."
                    />
                </div>
                <button
            ...
            {/* Row 2: Filters */}
            <div className={`${isFiltersOpen ? 'grid' : 'hidden'} lg:grid grid-cols-2 sm:grid-cols-3 gap-4 mt-3`}>
