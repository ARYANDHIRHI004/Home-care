...
export default function ComplaintFilters({ searchQuery, onSearchChange }) {
    const [isFiltersOpen, setIsFiltersOpen] = useState(false);

    const filterOptions = [
        { label: 'Status', options: ['All Statuses', 'New', 'Open', 'Investigating', 'Waiting Customer', 'Resolved', 'Closed', 'Rejected'] },
        { label: 'Priority', options: ['All Priorities', 'Low', 'Medium', 'High', 'Critical'] },
        { label: 'Service', options: ['All Services', 'Cleaning', 'Plumbing', 'Electrical', 'AC Repair', 'Appliance'] },
        { label: 'Date', options: ['Any Time', 'Today', 'Last 7 Days', 'Last 30 Days', 'This Month'] },
    ];
