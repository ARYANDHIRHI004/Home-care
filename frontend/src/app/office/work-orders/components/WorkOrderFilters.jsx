...
export default function WorkOrderFilters({ searchQuery, onSearchChange }) {
    return (
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm mb-6 flex flex-col md:flex-row gap-4 items-center justify-between transition-colors">
            <div className="relative w-full md:max-w-md">
                ...
                <input 
                    ...
                    placeholder="Search Work Order ID, Customer, Service..." 
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                {['Status', 'Priority', 'Partner', 'Service Category', 'Date Range', 'City'].map((filter) => (
