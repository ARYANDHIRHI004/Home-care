        ...
        <Dialog isOpen={isOpen} onClose={onClose} maxWidth="max-w-sm">
            <div className="p-6 text-center">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                    Are you sure you want to delete the work order <span className="font-semibold text-slate-700 dark:text-slate-300">{workOrder.id}</span>? This action cannot be undone.
                </p>
