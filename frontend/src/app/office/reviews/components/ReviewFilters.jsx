...
export default function ReviewFilters() {
    ...
    const filterOptions = [
        { label: 'Rating', options: ['Any Rating', '★★★★★', '★★★★☆', '★★★☆☆', '★★☆☆☆', '★☆☆☆☆'] },
        { label: 'Status', options: ['All Statuses', 'New', 'Replied', 'Escalated', 'Resolved', 'Ignored'] },
        { label: 'Category', options: ['All Categories', 'Cleaning', 'Plumbing', 'Electrical', 'Appliance Repair'] },
        { label: 'Date', options: ['Any Time', 'Last 7 Days', 'Last 30 Days', 'This Month', 'Last Month'] },
    ];

    return (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-6  top-20 z-10 min-w-0">
            {/* Row 1: Search */}
            <div className="flex gap-3 min-w-0">
                <div className="relative flex-1 min-w-0">
                    ...
                    <input
                        ...
                        placeholder="Search reviews, customer, booking ID..."
                    />
                </div>
                <button
            ...
            {/* Row 2: Filters - hidden by default on mobile, always visible on lg */}
            <div className={`${isFiltersOpen ? 'grid' : 'hidden'} lg:grid grid-cols-2 sm:grid-cols-4 gap-2 mt-3`}>
            ...
            {/* Row 3: Advanced & Clear (only when filters visible) */}
            {isFiltersOpen && (
