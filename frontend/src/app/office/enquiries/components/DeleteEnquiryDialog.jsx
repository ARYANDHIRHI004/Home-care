    ...
    return (
        <Dialog isOpen={isOpen} onClose={onClose} maxWidth="max-w-sm">
            <div className="p-6 text-center">
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Delete Record?</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                    Are you sure you want to delete the enquiry for <span className="font-semibold text-slate-700 dark:text-slate-300">{enquiry.customer}</span>? This action cannot be undone.
                </p>
