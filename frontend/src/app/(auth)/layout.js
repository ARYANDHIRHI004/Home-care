    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-[#F0F4FF] to-white px-4 py-10">
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <img src="/logo.png" alt="HomeCare" className="h-10 w-10 object-contain" />
          <span
        ...
        <p className="text-center text-xs text-[#0F172A]/60 mt-6">
          Need help? <a href="/support" className="text-[#2554F0] font-medium hover:underline">Contact support</a>
        </p>
      </div>
    </div>
  );
